...
from parsers import site_config
# from parsers import site_config_parser as site_cfg_parser
from parsers.scientific_alert import scientific_alert_factory as saf
from parsers.scientific_alert import inject_voevent_sci_alert_factory as inj_voevent_saf
from parsers.scientific_alert import comet_voevent_sci_alert_factory as comet_voevent_saf
from parsers.scientific_alert import sag_sci_alert_factory as sag_saf
from parsers.scientific_alert import suss_sci_alert_factory as suss_saf
from parsers.science_config import science_configuration

import Communicator.communicator as comm

from broker_system import verifyer
import os
...
def alert_entry(alert, origin, test_conditions=None):
    ...
    alert_allowed = verifyer.verify_alert(sci_alert, allowed_alert_types)
